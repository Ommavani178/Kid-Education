    ...
    <header class="header_section">
      <div class="container">
        <nav class="navbar navbar-expand-lg custom_nav-container ">
          <img width="220px" src="/xampp/htdocs/website/mynewwbsite/fanadesh-html/images\1665298850453.png">
      ...
      <div class="hero-container container">
        <div class="hero_detail-box">
          ...
          <div class="hero_btn-continer">
            <a href="C:\xampp\htdocs\website\my new wbsite\login page\regishtration-page.ht" class="call_to-btn btn_white-border">
              Register
            </a>
          </div>
        </div>
        <div class="hero_img-container">
          <div>
            <img src="C:\xampp\htdocs\website\my new wbsite\fanadesh-html\images\hero.png.png" alt="" class="img-fluid">
          </div>
        </div>
      </div>
    </section>
            ...
            <div class="carousel-inner">
                  ...
                  <div class="row">
                      <div class="col-md-3">
                        <div class="client_img-box">
                          <img src="D:\website\my new wbsite\fanadesh-html\images\client.jpg" alt="">
                        </div>
                      </div>
                      <div class="col-md-9">
              ...
              <div class="carousel-item">
                  <div class="row">
                      <div class="col-md-3">
                        <div class="client_img-box">
                          <img src="D:\website\my new wbsite\fanadesh-html\images\team-2.jpg" height="440px" width="350px">
                        </div>
                      </div>
                      <div class="col-md-9">
                        <div class="client_detail-box">
